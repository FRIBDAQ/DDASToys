...
public:
   ...
   */
  CFitEngine *
  createSerialFitEngine1(std::vector<std::pair<uint16_t, uint16_t>> &data);
  /**
   * @brief Create a single pulse Cuda-enabled fit engine.
   * @param data (x, y) values of the data to be fit.
   * @return Pointer to the created fit engine object.
   */
  CFitEngine *
  createCudaFitEngine1(std::vector<std::pair<uint16_t, uint16_t>> &data);
  /**
   ...
   */
  CFitEngine *
  createSerialFitEngine2(std::vector<std::pair<uint16_t, uint16_t>> &data);
  /**
   ...
   */
  CFitEngine *
  createCudaFitEngine2(std::vector<std::pair<uint16_t, uint16_t>> &data);
};
