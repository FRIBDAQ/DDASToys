...
public:
   ...
   */
  std::vector<double> getSinglePulseFit(const ddastoys::DDASFitHit &hit,
   ...
   * @return Vector of fit values for range [low, high].
   */
  std::vector<double> getDoublePulseFit(const ddastoys::DDASFitHit &hit,
                                        unsigned low, unsigned high);
  /**
...
private:
   ...
   */
  double singlePulse(unsigned crate, unsigned slot, unsigned chan, double A1,
                     double k1, double k2, double x1, double C, double x);
  /**
   ...
   * @return   Fit value at x.
   */
  double doublePulse(unsigned crate, unsigned slot, unsigned chan, double A1,
                     double k1, double k2, double x1, double A2, double k3,
                     double k4, double x2, double C, double x);
  /**
