...
{  
     ...
     *        fitting framework.
     *     3) The extra data is sizeof(FitInfo) from FitExtender - the extra
     *        data is FitExtender fit information
     *     4) Anything else - we don't know how to do with and fail with an
     *        error message.
     */
    
    const std::uint32_t* pHitSize
	...
	throw std::length_error(
	    "Inconsistent event size for DDASHit or extended hit"
	    );
    }
