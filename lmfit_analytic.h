 ...
 */
void lmfit1(fit1Info *pResult, std::vector<uint16_t> &trace,
 ...
 */
void lmfit2(fit2Info *pResult, std::vector<uint16_t> &trace,
            const std::pair<unsigned, unsigned> &limits,
 ...
 *   above this value are removed from the fit.
 */
void lmfit2fixedT(fit2Info *pResult, std::vector<uint16_t> &trace,
                  const std::pair<unsigned, unsigned> &limits,
