...
// See the header; CRingItemProcessor.h for more information about the class
// as a whole.
...
CRingItemProcessor::processScalerItem(CRingScalerItem& item)
{
  ...
  for (unsigned i = 0; i < item.getScalerCount(); i++) {
...
/**
 * processEvent
 *   Process physics events. This is the function to change for handling 
 *   event data.
 *
