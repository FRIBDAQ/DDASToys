...
/** @file:  CRingFileOutputter.cpp
 *  @brief: Implements CRingFileOutputter
 *
 */

#include "CRingFileOutputter.h"
...
CRingFileOutputter::CRingFileOutputter(const char* filename) :
 ...
 */
void
CRingFileOutputter::outputItem(int id, void* pData)
{
 ...
 */
void
CRingFileOutputter::deleteIfNeeded(FragmentInfo& info)
{
