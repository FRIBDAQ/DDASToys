 ...
 */
double singlePulse(double S1, double x1, double C, double x,
 ...
 */
double chiSquare1(double S1, double x1, double C,
 ...
 * @return The chi-square goodness-of-fit statistic.
 */
double chiSquare2(double S1, double x1, double S2, double x2, double C,
                  const std::vector<std::pair<uint16_t, uint16_t>> &points,
                  const std::vector<double> &trace_template);
